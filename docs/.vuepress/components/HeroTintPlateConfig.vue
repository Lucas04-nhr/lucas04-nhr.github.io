...
const hero = {
  name: "Theme Plume",
  tagline: "Next Theme",
  text: "Minimal, feature-rich",
  actions: [],
};
const modeList: { value: Mode; label: string }[] = [
  { value: "single", label: "Single color" },
  { value: "triplet", label: "Three colors" },
  { value: "custom", label: "Three colors + offset" },
];
  ...
  <div class="hero-tint-plate-wrapper">
    ...
    <p>
      <label for="tint-plate-is-dark">
        <input id="tint-plate-is-dark" v-model="isDark" type="checkbox" /> Dark
        mode
      </label>
    </p>
