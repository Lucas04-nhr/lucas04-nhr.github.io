...
```bash
LSNRCTL for Linux: Version 21.0.0.0.0 - Production on 30-4 月 -2024 19:55:30
...
```bash
LSNRCTL for Linux: Version 21.0.0.0.0 - Production on 30-4 月 -2024 19:55:35
...
写入/opt/app/admin/diag/tnslsnr/A201-2-7/listener/alert/log.xml 的日志信息
