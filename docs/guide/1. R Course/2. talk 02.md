...
The book updated to 2^nd^ ed. on July,2023, here’ s a [link](https://r4ds.hadley.nz) to the official website.
  ...
  <LinkCard 
    ...
    href="[/docs/hust-gp-template/faqs/](https://github.com/Lucas04-nhr/R-for-Data-Science/blob/main/talk02.pdf)" > 
  </LinkCard>

  <LinkCard 
    icon="ic:round-document-scanner"
    title="View the original Rmd file"
    href="https://github.com/Lucas04-nhr/R-for-Data-Science/blob/main/talk02.Rmd" > 
  </LinkCard>
  :::
