...
<LinkCard 
    ...
    href="https://github.com/Lucas04-nhr/R-for-Data-Science/blob/main/talk04.pdf" >
</LinkCard>
...
## IO and working enviroment management {#io-and-working-enviroment-management}

Each R session is a separate **work space** containing its own data, variables, and operation history.

![R sessions & workspaces](https://cdn.jsdelivr.net/gh/Lucas04-nhr/Pictures@main/uPic/r_sessions.png)
...
![R sessions in RStudio](https://cdn.jsdelivr.net/gh/Lucas04-nhr/Pictures@main/uPic/r_session_in_rstudio.png)

If you want to coding with R using PyCharm or other JetBrains IDE (i.e. IntelliJ, CLion, etc.), remember to install the _R Language Plug-in_

![R Language plug-in in PyCharm](https://cdn.jsdelivr.net/gh/Lucas04-nhr/Pictures@main/uPic/image-20231202111619635.png)
...
### Start a new RStudio session by creating a new project {#start-new-rstudio-session}
...
### Variables in working space in RStudio {#variables-in-working-space-in-rstudio}

The "Environment" window in the upper right corner of RStudio shows all the variables of the current workspace.

![RStudio Environment window](https://cdn.jsdelivr.net/gh/Lucas04-nhr/Pictures@main/uPic/rstudio_enviroment_window.png)

### Save and restore work space {#save-and-restore-work-space}
...
### Save selected variables {#save-selected-variables}
...
### Close and (re)open a project {#close-and-reopen-a-project}
...
- In RStudio and similar IDEs, there are some preferences to choose
  ...
  ::: info
  In PyCharm, the preferences window looks like this:
  ::: center
...
::: info
When in PyCharm or VS Code, simply drag the working directory to its main window, remember to trust the project.
:::
...
### Play around with `levels()` {#play-around-with-levels}
...
### Use factor to clean data {#clean-data}

::: info
This part is about the usage of `fct_xxx()` functions.
:::
...
### Usage of factors in drawing plots {#usage-of-factors-in-drawing-plots}
...
![Response barplot](https://cdn.jsdelivr.net/gh/Lucas04-nhr/Pictures@main/uPic/response_barplot.png)
...
### Using `factor` to change values {#using-factor-to-change-values}
...
The five most important dplyr verbs that operate on a single table are:
...
### Delete useless `levels` {#delete-useless-levels}

When you read a data table using `read.delim()` or `read.csv()`, if you set the parameter `stringsAsFactors = T`, R will automatically convert character variables into `factors`.
...
::: demo-wrapper title="Output"
![Output of `mouse.genes`](https://cdn.jsdelivr.net/gh/Lucas04-nhr/Pictures@main/uPic/image-20231202135803901.png)
:::

If you draw a plot without deleting the useless `levels`, you will get this result:

![Mouse gene plot 01](https://cdn.jsdelivr.net/gh/Lucas04-nhr/Pictures@main/uPic/mouse_gene_plot01.png)
...
::: demo-wrapper title="Output"
![Output of `mouse.chr_10_12`](https://cdn.jsdelivr.net/gh/Lucas04-nhr/Pictures@main/uPic/image-20231202141212937.png)
:::

Then, you’ll get the plot like this:

![Mouse gene plot 02](https://cdn.jsdelivr.net/gh/Lucas04-nhr/Pictures@main/uPic/mouse_gene_plot02.png)
...
![Mouse gene plot 03](https://cdn.jsdelivr.net/gh/Lucas04-nhr/Pictures@main/uPic/mouse_gene_plot03.png)
