...
webpackJsonpL2Dwidget([0], {
    79: function(t, e, i) {
        ...
        var r, o = i(26), n = i(83), s = i(80), _ = i(81), a = i(86), h = i(84), l = i(82), $ = i(39), u = (r = $) && r.__esModule ? r : {
            default: r
        };
        var p = null
          , c = void 0
        ...
        function L(t) {
            ...
            var e = n.currCanvas.getBoundingClientRect()
              ...
              , s = x(o.x - e.left)
              , _ = I(o.y - e.top);
            l.cDefine.DEBUG_MOUSE_LOG && console.log("modelTapEvent onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"),
            i,
            r,
            S.emit("tap", t),
            p.tapEvent(s, _)
            ...
            if ("mousedown" == t.type)
                ...
                !function(t) {
                    ...
                    var e = n.currCanvas.getBoundingClientRect()
                      ...
                      , s = x(o.x - e.left)
                      , _ = I(o.y - e.top);
                    l.cDefine.DEBUG_MOUSE_LOG && console.log("modelTurnHead onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"),
                    i,
                    r,
                    g.setPoint(s, _)
                }(t);
        ...
        function A(t) {
            ...
            _ = x(s.x - i.left),
            a = I(s.y - i.top),
            l.cDefine.DEBUG_MOUSE_LOG && console.log("followPointer onMouseMove device( x:" + e.clientX + " y:" + e.clientY + " ) view( x:" + _ + " y:" + a + ")"),
            T && (r,
            o,
            g.setPoint(_, a))) : "touchend" == t.type && M()
        }
        function x(t) {
        ...
        e.theRealInit = function(t) {
            ...
            p = new a.cManager(S),
            g = new _.L2DTargetPoint;
            var e, i, r = n.currCanvas.getBoundingClientRect(), $ = r.height / r.width, T = l.cDefine.VIEW_LOGICAL_LEFT, P = l.cDefine.VIEW_LOGICAL_RIGHT, v = -$, L = $;
            (y = new _.L2DViewMatrix).setScreenRect(T, P, v, L),
            ...
            e = u.default.mobile() && o.config.mobile.scale || o.config.model.scale,
            y.adjustScale(0, 0, e),
            (d = new _.L2DMatrix44).multScale(1, r.width / r.height),
            (m = new _.L2DMatrix44).multTranslate(-r.width / 2, -r.height / 2),
            m.multScale(2 / r.width, -2 / r.height),
            s.Live2D.setGL(n.currWebGL),
            n.currWebGL.clearColor(0, 0, 0, 0),
            i = o.config.model.jsonPath,
            p.reloadFlg = !0,
            p.count++,
            p.changeModel(n.currWebGL, i),
            f || (f = !0,
            function t() {
                !function() {
                    h.MatrixStack.reset(),
                ...
                e(t, n.currCanvas),
                void 0 !== c && (c(n.currCanvas.toDataURL()),
                c = void 0)
            }())
        }
        ,
    ...
    80: function(t, e, i) {
        ...
        (function(t) {
            ...
            o.prototype.releaseShader = function() {
                for (var t = _t.frameBuffers.length, e = 0; e < t; e++)
                    this.gl.deleteFramebuffer(_t.frameBuffers[e].framebuffer);
                _t.frameBuffers = [],
                _t.glContext = []
            }
            ,
            ...
            o.prototype.setupClip = function(t, e) {
                ...
                if (i > 0) {
                    ...
                    e.gl.viewport(0, 0, _t.clippingMaskBufferSize, _t.clippingMaskBufferSize),
                    this.setupLayoutBounds(i),
                    e.gl.bindFramebuffer(e.gl.FRAMEBUFFER, _t.frameBuffers[this.curFrameNo].framebuffer),
            ...
            s.prototype.updateParam = function(t, e) {
                if (e._$AT && !e._$9L) {
                    ...
                    var o = this._$V0;
                    0 <= (o = o * (0 == this._$dP ? 1 : at._$r2((i - e._$bs) / this._$dP)) * (0 == this._$eo || e._$Do < 0 ? 1 : at._$r2((e._$Do - i) / this._$eo))) && o <= 1 || console.log("### assert!! ### "),
            ...
            u.prototype._$oo = function(t, e) {
                ...
                this.p1._$xT();
                var r, o, n = -Math.atan2(this.p1.y - this.p2.y, this.p1.x - this.p2.x), s = Math.cos(n), _ = Math.sin(n), a = 9.8 * this.p2._$p, h = this._$Db * vt._$bS, l = a * Math.cos(n - h);
                r = l * _,
                o = l * s;
                var $ = -this.p1.fx * _ * _
                  , u = -this.p1.fy * _ * s
            ...
            S._$Z2 = function(t, e, i, r) {
                ...
                o <= 0)
                    return r[n[0]];
                if (1 == o)
                    return (_ = r[n[0]]) + ((a = r[n[1]]) - _) * ($ = s[0]) | 0;
                if (2 == o) {
                    var _ = r[n[0]]
                      , a = r[n[1]]
                      , h = r[n[2]]
                ...
                if (4 == o) {
                    var S, v = r[n[0]], L = r[n[1]], M = r[n[2]], E = r[n[3]], A = r[n[4]], x = r[n[5]], I = r[n[6]], w = r[n[7]], D = r[n[8]], O = r[n[9]], R = r[n[10]], b = r[n[11]], F = r[n[12]], C = r[n[13]], N = r[n[14]], B = r[n[15]], G = ($ = s[0],
                    u = s[1],
                    P = s[2],
                    s[3]);
            ...
            S._$Vr = function(t, e, i, r, o, n, s, _) {
                ...
                if (a <= 0) {
                    ...
                    l[1])
                      ...
                      , Y = st * R * m;
                    for (c = 0; c < $; )
                        n[u] = b * L[c] + F * M[c] + C * E[c] + N * A[c] + B * I[c] + G * w[c] + U * D[c] + Y * O[c],
                        ++c,
                        n[u + 1] = b * L[c] + F * M[c] + C * E[c] + N * A[c] + B * I[c] + G * w[c] + U * D[c] + Y * O[c],
                        ++c,
                        u += _
                } else if (4 == a) {
                    ...
                    R = l[1],
                    l[2]), _t = l[3], at = 1 - _t, ht = at * (V = 1 - st) * (k = 1 - R) * (g = 1 - m), lt = at * V * k * m, $t = at * V * R * g, ut = at * V * R * m, pt = at * st * k * g, ct = at * st * k * m, ft = at * st * R * g, gt = at * st * R * m, yt = _t * V * k * g, dt = _t * V * k * m, mt = _t * V * R * g, Tt = _t * V * R * m, Pt = _t * st * k * g, St = _t * st * k * m, vt = _t * st * R * g, Lt = _t * st * R * m;
                    for (c = 0; c < $; )
                        n[u] = ht * X[c] + lt * z[c] + $t * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + yt * Z[c] + dt * K[c] + mt * tt[c] + Tt * et[c] + Pt * it[c] + St * rt[c] + vt * ot[c] + Lt * nt[c],
                        ++c,
                        n[u + 1] = ht * X[c] + lt * z[c] + $t * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + yt * Z[c] + dt * K[c] + mt * tt[c] + Tt * et[c] + Pt * it[c] + St * rt[c] + vt * ot[c] + Lt * nt[c],
                        ++c,
                        u += _
                } else {
                    for (var Mt = 1 << a, Et = new Float32Array(Mt), At = 0; At < Mt; At++) {
                        for (var xt = At, It = 1, wt = 0; wt < a; wt++)
                            It *= xt % 2 == 0 ? 1 - l[wt] : l[wt],
                            xt /= 2;
                        Et[At] = It
                    }
            ...
            C.prototype.add = function(t) {
                if (this._$P.length <= this.size) {
                    ...
                    x._$jT(this._$P, 0, e, 0, this.size),
                    this._$P = e
                }
            ...
            U.prototype._$UT = function(t, e) {
                ...
                return x._$jT(t, 0, i, 0, t.length),
                i
            }
            ,
            ...
            function z() {
                i || (A.prototype.constructor.call(this),
                this._$GS = null,
                this._$Y0 = null)
            }
            function H(t) {
            ...
            X.prototype._$nS = function(t) {
                var e = Math.max(2 * this._$sb.length, t + 1 + 10)
                  , i = new Int32Array(e);
                x._$jT(this._$sb, 0, i, 0, this._$sb.length),
                this._$sb = i;
                var r = new Array;
            ...
            z.prototype._$2b = function(t, e) {
                ...
                this._$32()) {
                    ...
                    if (i._$8r == A._$ur && (i._$8r = t.getBaseDataIndex(r)),
                    i._$8r < 0)
            ...
            z.prototype._$nb = function(t, e, i, r, o, n, s) {
                this != e._$GT() && console.log("### assert!! ### ");
                for (var _, a, h = e, l = null != h._$Wr ? h._$Wr : h._$Yr, $ = Math.sin(vt._$bS * l._$qT), u = Math.cos(vt._$bS * l._$qT), p = h.getTotalScale(), c = l.reflectX ? -1 : 1, f = l.reflectY ? -1 : 1, g = u * p * c, y = -$ * p * f, d = $ * p * c, m = u * p * f, T = l._$fL, P = l._$gL, S = o * s, v = n; v < S; v += s)
                    _ = i[v],
                    a = i[v + 1],
                    r[v] = g * _ + y * a + T,
                    r[v + 1] = d * _ + m * a + P
                        ...
                        if ("#" != n)
                            if ("$" != n) {
                                if (97 <= s && s <= 122 || 65 <= s && s <= 90 || "_" == n) {
                                    ...
                                    if (u >= 0) {
                                        var _ = new N;
                                        w.startsWith(t, $, J._$cs) ? (_._$RP = N._$hs,
                                        _._$4P = w.createString(t, $, u - $)) : w.startsWith(t, $, J._$ar) ? (_._$4P = w.createString(t, $ + 7, u - $ - 7),
                                        w.startsWith(t, $ + 7, "ANCHOR_X") ? _._$RP = N._$xs : w.startsWith(t, $ + 7, "ANCHOR_Y") ? _._$RP = N._$us : w.startsWith(t, $ + 7, "SCALE_X") ? _._$RP = N._$qs : w.startsWith(t, $ + 7, "SCALE_Y") ? _._$RP = N._$Ys : w.startsWith(t, $ + 7, "X") ? _._$RP = N._$ws : w.startsWith(t, $ + 7, "Y") && (_._$RP = N._$Ns)) : (_._$RP = N._$Fr,
                                        _._$4P = w.createString(t, $, u - $)),
                                        e.motions.push(_);
                                        var a = 0
                                          , h = [];
            ...
            Z.transformPoints_sdk2 = function(e, i, r, o, n, s, _, a) {
                for (var h, l, $, u = r * n, p = 0, c = 0, f = 0, g = 0, y = 0, d = 0, m = !1, T = o; T < u; T += n) {
                    ...
                    (P = v * _) < 0 || S < 0 || _ <= P || a <= S) {
                            ...
                            if (v <= 0)
                                if (L <= 0) {
                                    var w = s[2 * (0 + 0 * M)]
                                      ...
                                      , C = p - 2 * f - 2 * y
                                      , N = c - 2 * g - 2 * d;
                                    (B = .5 * (v - -2)) + (G = .5 * (L - -2)) <= 1 ? (i[T] = C + (b - C) * B + (O - C) * G,
                                    i[T + 1] = N + (F - N) * B + (R - N) * G) : (i[T] = w + (O - w) * (1 - B) + (b - w) * (1 - G),
                                    i[T + 1] = D + (R - D) * (1 - B) + (F - D) * (1 - G))
                                } else if (L >= 1) {
                                    b = s[2 * (0 + a * M)],
                                    F = s[2 * (0 + a * M) + 1],
                                    C = p - 2 * f + 1 * y,
                                    ...
                                    O = p - 2 * f + 3 * y,
                                    R = c - 2 * g + 3 * d;
                                    (B = .5 * (v - -2)) + (G = .5 * (L - 1)) <= 1 ? (i[T] = C + (b - C) * B + (O - C) * G,
                                    i[T + 1] = N + (F - N) * B + (R - N) * G) : (i[T] = w + (O - w) * (1 - B) + (b - w) * (1 - G),
                                    i[T + 1] = D + (R - D) * (1 - B) + (F - D) * (1 - G))
                                } else {
                                    (k = 0 | S) == a && (k = a - 1);
                                ...
                                if (L <= 0) {
                                    ...
                                    b = p + 3 * f - 2 * y,
                                    F = c + 3 * g - 2 * d;
                                    (B = .5 * (v - 1)) + (G = .5 * (L - -2)) <= 1 ? (i[T] = C + (b - C) * B + (O - C) * G,
                                    i[T + 1] = N + (F - N) * B + (R - N) * G) : (i[T] = w + (O - w) * (1 - B) + (b - w) * (1 - G),
                                    i[T + 1] = D + (R - D) * (1 - B) + (F - D) * (1 - G))
                                } else if (L >= 1) {
                                    C = s[2 * (_ + a * M)],
                                    ...
                                    w = p + 3 * f + 3 * y,
                                    D = c + 3 * g + 3 * d;
                                    (B = .5 * (v - 1)) + (G = .5 * (L - 1)) <= 1 ? (i[T] = C + (b - C) * B + (O - C) * G,
                                    i[T + 1] = N + (F - N) * B + (R - N) * G) : (i[T] = w + (O - w) * (1 - B) + (b - w) * (1 - G),
                                    i[T + 1] = D + (R - D) * (1 - B) + (F - D) * (1 - G))
                                } else {
                                    var k;
                        ...
                        h = 2 * ((0 | P) + (0 | S) * (_ + 1)),
                        (l = P - (0 | P)) + ($ = S - (0 | S)) < 1 ? (i[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (_ + 1)] * $,
            ...
            Z.prototype.transformPoints_sdk1 = function(t, e, i, r, o, n, s) {
                for (var _, a, h, l, $, u, p, c = e, f = this._$o, g = this._$A, y = o * s, d = null != c._$hr ? c._$hr : c._$Cr, m = n; m < y; m += s)
                    _t._$ts ? (_ = i[m],
                    a = i[m + 1],
                    _ < 0 ? _ = 0 : _ > 1 && (_ = 1),
                    a < 0 ? a = 0 : a > 1 && (a = 1),
            ...
            ot.prototype.drawElements = function(t, e, i, r, o, n, s, a) {
                try {
                    ...
                    for (var h = e.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, c = this._$uP, f = this._$6r, g = this._$3r, y = ot.tr, d = ot._$Ti, m = ot._$Pi, P = ot._$B, S = 0; S < h; S += 3) {
                        ...
                        T._$ni(w, D, E, A, x - E, I - A, -(I - A), x - E, m);
                        var H = (m[0] - d[0]) / d[1]
                          , W = Math.min(O, b, C)
                          , j = Math.max(O, b, C)
                          , q = Math.min(R, F, N)
                        ...
                        _t.USE_CACHED_POLYGON_IMAGE) {
                            ...
                            !et.gl_cacheImage[S]) {
                                ...
                                rt.translate(-Q, -Z),
                                ot.clip(rt, y, n, k, O, R, b, F, C, N, E, A, x, I, w, D),
                                rt.drawImage(t, 0, 0),
                                et.gl_cacheImage[S] = {
                                    cacheCanvas: it,
                                    cacheContext: rt
                            ...
                            _t.IGNORE_CLIP || ot.clip(u, y, n, k, O, R, b, F, C, N, E, A, x, I, w, D),
            ...
            ot.expandClip = function(t, e, i, r, o, n, s, _, a, h) {
                var l = s - o
                  ...
                  , C = h + c * v / L
                  , N = ot._$50;
                return null != e._$P2(N) && (ot.clipWithTransform(t, N, M, E, A, x, I, w, D, O, F, C, R, b),
                !0)
            }
            ,
    ...
    83: function(t, e, i) {
        ...
        e.createElement = function() {
            ...
            a.setAttribute("width", r.config.display.width * r.config.display.superSample),
            a.setAttribute("height", r.config.display.height * r.config.display.superSample),
            a.style.setProperty("position", "absolute"),
            a.style.setProperty("left", "0px"),
            a.style.setProperty("top", "0px"),
            a.style.setProperty("width", r.config.display.width + "px"),
            a.style.setProperty("height", r.config.display.height + "px"),
            r.config.dev.border && a.style.setProperty("border", "dashed 1px #CCC"),
            i.appendChild(a),
            e.currCanvas = _ = document.getElementById(r.config.name.canvas),
            o.L2Dwidget.emit("create-canvas", a),
            function() {
    ...
    88: function(t, e, i) {
        ...
        a.prototype.load = function(t, e, i) {
            this.setUpdating(!0),
